...
import umy.project.ktp.exceptions.NonexistentEntityException;
import umy.project.ktp.exceptions.PreexistingEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("umy_project.ktp_jar_0.0.1-SNAPSHOTPU");
