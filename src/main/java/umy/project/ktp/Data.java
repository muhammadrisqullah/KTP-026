...
public class Data implements Serializable {
    ...
    public Data(Long id, String noktp, String nama, Date tgllahir, String jeniskelamin, String alamat, String agama, String status, String kewarganegara) {
        this.id = id;
        this.noktp = noktp;
        this.nama = nama;
    ...
    public String toString() {
        return "umy.project.ktp.Data[ id=" + id + " ]";
    }
